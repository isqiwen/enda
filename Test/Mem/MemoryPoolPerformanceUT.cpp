...
// {
//     std::unique_ptr<memory_stats<memory_pool>> mp = std::make_unique<memory_stats<memory_pool>>(1ULL << 33,           // min_total_alloc_size: 8GB
//                                                                                                 64,                   // min_block_alloc_size: 64 bytes
//                                                                                                 512ULL * 1024 * 1024, // max_block_alloc_size: 512MB
//                                                                                                 512ULL * 1024 * 1024  // min_superblock_size: 512MB
//     );
...
//             {
//                 size_t size = dist(gen);
//                 blk_t  blk  = POOL_ALLOC_STATS(*mp, size);
//                 if (blk.ptr)
//                 {
//                     mp->deallocate(blk);
//                 }
