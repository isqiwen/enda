/**
 * @file GTestTools.hpp
 * @brief Provides convenient tools for checking enda::basic_array and enda::basic_array_view objects with googletest.
 */
...
{
    enda::array<enda::get_value_t<X>, enda::get_rank<X>> x_reg = x;
    enda::array<enda::get_value_t<X>, enda::get_rank<X>> y_reg = y;
