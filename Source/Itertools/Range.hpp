...
namespace enda::itertools
{
    ...
    public:
        ...
        {
            if (step_ == 0)
                throw std::runtime_error("Step-size cannot be zero in construction of integer range");
        }
        ...
        struct const_iterator
        {
             ...
             */
            [[nodiscard]] bool operator==(const_iterator const& other) const noexcept { return (other.pos == this->pos) || (other.atEnd() && this->atEnd()); }
    ...
    [[nodiscard]] auto product_range(Is... is)
    {
