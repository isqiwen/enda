...
namespace enda::itertools
{
    ...
    public:
        ...
        /**
         * @brief Equal-to operator for two itertools::zip_iter objects.
         *
    ...
    public:
         ...
         * @return itertools::zip_iter constructed from the begin iterators of the original ranges.
         */
     ...
     * elements as the shortest given range.
     *
     ...
     */
    template<typename... Rs>
    [[nodiscard]] zipped<Rs...> zip(Rs&&... rgs)
    {
